...
public class Stop implements Writeable {
    ...
    private Map<Passenger, Stop> nextStop = new LinkedHashMap<>();
     ...
     *
     * When a passenger arrives at a stop, the stop should use its routing
    ...
    public void addPassenger(Passenger passenger) {
        ...
        if (passenger == null) {
            ...
            this.passengers.add(passenger);
            nextStop.put(passenger, routingTable.nextStop(passenger.getDestination()));
        }
    }
    ...
    public void transportDepart(PublicTransport transport, Stop nextStop) {
        ...
        try {
            for (Map.Entry<Passenger, Stop> entry : this.nextStop.entrySet()) {
                if (entry.getValue().equals(nextStop)) {
                    transport.addPassenger(entry.getKey());
                }
            }
