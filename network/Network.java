...
public class Network {
     ...
     *
     * If the stop is already in the list, a DuplicateStopException should
     * be thrown
     *
     * @param stop The stop to add to the network.
     * @throws DuplicateStopException If the given stop already
    ...
    public void addStop(Stop stop) throws DuplicateStopException {
        ...
        try {
            for (Stop equalStop : stops) {
                if (equalStop.equals(stop)) {
        ...
        } catch (DuplicateStopException dse) {
            throw new DuplicateStopException();
        }
    }
     ...
     *
     * f any of the stops in the given list already exist in the network,
     ...
     * the network. If there are any duplicate stops, none of the stops
     * should be added (i.e. either all of the stops are added, or none are).
     */
    public void addStops(List<Stop> stops) throws DuplicateStopException {
        try {
            for (Stop stop : stops) {
                ...
                for (Stop equalStop : this.stops) {
                    if (stop.equals(equalStop)) {
                        throw new DuplicateStopException();
                    }
                }
            }
